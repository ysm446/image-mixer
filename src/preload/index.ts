...
const api: ImageMixerApi = {
  ...
  getRecentLibraries: () => ipcRenderer.invoke('library:recent'),
  openLibrary: (rootPath) => ipcRenderer.invoke('library:open', rootPath),
  ...
  saveSession: (sessionId, snapshot: SessionSnapshot, protectedPaths?: string[]) => ipcRenderer.invoke('session:save', sessionId, snapshot, protectedPaths),
